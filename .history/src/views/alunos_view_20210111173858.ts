...
export default {
  render(aluno: Aluno) {
    ...
    return {
      ...
      alunoInsta: aluno.alunoInsta,
      alunoCamiseta: aluno.alunoCamiseta,
  ...
  renderShortList(alunos: Aluno[]) {
    return alunos.map(aluno => this.renderSL(aluno));
  }
}