...
export default {
  async index(request: Request, response: Response) {
    ...
    const alunos = await observacoesRepository.find({
      relations: ['turma']
    });
    console.log(alunos)
    return response.json(observacoesView.renderShortList(alunos));
  },
  ...
  async show(request: Request, response: Response) {
    ...
    const aluno = await observacoesRepository.findOneOrFail(id);
    console.log(aluno)
